...
### Deploy the module High availability existing vnet
...
module "ha-existing-vnet" {
  source                        = "github.com/llgjermeni/checkpoint/high-availability-existing-vnet"
