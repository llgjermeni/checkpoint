...
### Deploy the module Vmss existing vnet
...
With this module you are going to create vnet and subnets before the deployment.
...
//********************** VMSS existing vnet**************************//
module "vmss-existing-vnet" {
  source                        = "github.com/llgjermeni/checkpoint/vmss-existing-vnet"
  

  subscription_id               = "xxxxxxxxxxxxxxxxxx" # "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
  source_image_vhd_uri          = "noCustomUri"                          # "noCustomUri"
  resource_group_name           = module.common.resource_group_name
  location                      = module.common.resource_group_location
  vmss_name                       = "checkpoint-vmss-terraform"                           # "checkpoint-mgmt-terraform"
  ...
  maximum_number_of_vm_instances  = 10                    # 10
  management_name                 = "mgmt"                                   # "mgmt"
  management_IP                   = "13.92.42.181"                                     # "13.92.42.181"
  management_interface            = "eth1-private"                              # "eth1-private"
  configuration_template_name     = "vmss_template"                       # "vmss_template"
  notification_email              = ""     # ""
  frontend_load_distribution      = "Default"        # "Default"
  backend_load_distribution       = "Default"        # "Default"
  
  ############------Networking-------###################
  vnet_name                       = "check-vnet"              # "checkpoint-mgmt-vnet"
  vnet_resource_group             = "network-rg"             # "existing-vnet"
  frontend_subnet_name            = "Frontend"                              # "frontend"
  backend_subnet_name             = "Backend"                              # "backend"
  backend_lb_IP_address           = 4           # 4
}
