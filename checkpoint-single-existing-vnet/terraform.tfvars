...
# resource_group_name   = "checkpoint-rg"                        # "checkpoint-mgmt-terraform"
...
# ############------Networking-------###################
# vnet_name                     = "aks-network"              # "checkpoint-mgmt-vnet"
# vnet_rg                       = "network-rg"
# # address_space                 = "10.0.0.0/16"                  # "10.0.0.0/16"
# # subnet_prefixes               = ["10.0.1.0/24", "10.0.2.0/24"] # "10.0.0.0/24"
